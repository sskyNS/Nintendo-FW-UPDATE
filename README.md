...
[![Firmware.zip Downloads](https://img.shields.io/badge/dynamic/json?style=flat-square&color=green&label=Firmware.zip&query=$.assets[0].download_count&url=https://api.github.com/repos/sskyNS/Nintendo-FW-UPDATE/releases/latest)](https://github.com/sskyNS/Nintendo-FW-UPDATE/releases/latest/download/Firmware.zip)
